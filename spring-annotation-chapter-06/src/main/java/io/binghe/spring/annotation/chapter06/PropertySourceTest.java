 ...
 */
package io.binghe.spring.annotation.chapter06;

import io.binghe.spring.annotation.chapter06.config.PropertySourceConfig;
 ...
 * @version 1.0.0
 * @description 测试@PropertySource注解的案例
