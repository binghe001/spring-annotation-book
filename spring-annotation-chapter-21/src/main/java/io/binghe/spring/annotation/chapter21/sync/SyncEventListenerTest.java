 ...
 */
package io.binghe.spring.annotation.chapter21.sync;

import io.binghe.spring.annotation.chapter21.event.ListenerEvent;
import io.binghe.spring.annotation.chapter21.sync.config.SyncEventListenerConfig;
import org.springframework.context.annotation.AnnotationConfigApplicationContext;

/**
 * @author binghe(微信 : hacker_binghe)
 * @version 1.0.0
 * @description 事件监听机制测试类
