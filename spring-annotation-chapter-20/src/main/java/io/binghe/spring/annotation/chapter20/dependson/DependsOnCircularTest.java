 ...
 */
package io.binghe.spring.annotation.chapter20.dependson;

import io.binghe.spring.annotation.chapter20.dependson.bean.DependsOnCircularBeanA;
import io.binghe.spring.annotation.chapter20.dependson.config.DependsOnCircularConfig;
import org.springframework.context.annotation.AnnotationConfigApplicationContext;

/**
 * @author binghe(微信 : hacker_binghe)
 * @version 1.0.0
 * @description @DependsOn注解的循环依赖
