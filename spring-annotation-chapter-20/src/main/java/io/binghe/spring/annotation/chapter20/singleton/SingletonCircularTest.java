 ...
 */
package io.binghe.spring.annotation.chapter20.singleton;

import io.binghe.spring.annotation.chapter20.singleton.bean.SingletonCircularBeanA;
import io.binghe.spring.annotation.chapter20.singleton.config.SingletonCircularConfig;
import org.springframework.context.annotation.AnnotationConfigApplicationContext;

/**
 * @author binghe(微信 : hacker_binghe)
 * @version 1.0.0
 * @description 单例Bean循环依赖
