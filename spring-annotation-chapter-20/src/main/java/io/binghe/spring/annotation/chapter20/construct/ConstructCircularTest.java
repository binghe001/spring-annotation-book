 ...
 */
package io.binghe.spring.annotation.chapter20.construct;

import io.binghe.spring.annotation.chapter20.construct.bean.ConstructCircularBeanA;
import io.binghe.spring.annotation.chapter20.construct.config.ConstructCircularConfig;
import org.springframework.context.annotation.AnnotationConfigApplicationContext;

/**
 * @author binghe(微信 : hacker_binghe)
 * @version 1.0.0
 * @description 基于构造方法循环依赖
