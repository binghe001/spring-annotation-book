 ...
 */
package io.binghe.spring.annotation.chapter20.special;

import io.binghe.spring.annotation.chapter20.special.bean.SpecialCircularBeanA;
import io.binghe.spring.annotation.chapter20.special.config.SpecialCircularConfig;
import org.springframework.context.annotation.AnnotationConfigApplicationContext;

/**
 * @author binghe(微信 : hacker_binghe)
 * @version 1.0.0
 * @description 单例Bean的特殊情况
